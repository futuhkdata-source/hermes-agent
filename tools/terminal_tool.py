...
Department-routed one-shot profile runs cannot use background=true as a durable proactive-reporting path; the tool refuses background mode there because the routed subprocess exits after its reply.
